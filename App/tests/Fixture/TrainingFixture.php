...
class TrainingFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'level' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'skill_id' => 1,
            'level' => 1,
            'created' => '2015-07-30 21:21:49',
            'modified' => '2015-07-30 21:21:49'
        ],
    ];
}
