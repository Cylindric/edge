...
class Talents extends AbstractMigration
{
    ...
    public function change()
    {
        ...
        $table->addColumn('name', 'string', ['default' => null, 'limit' => 255, 'null' => false])
            ...
            ->addColumn('activation_type', 'text', ['default' => null, 'limit' => 20])
            ->addColumn('page', 'integer', ['default' => null, 'limit' => 11])
        ...
        $data = [
            ['name' => 'Adversary', 'ranked' => true, 'activation_type' => 'Passive', 'page' => 132],
            ['name' => 'Anatomy Lessons', 'ranked' => false, 'activation_type' => 'Active (Incidental)', 'page' => 132],
